...
public class InfoAdapterTwo extends ArrayAdapter<Information> {
    public InfoAdapterTwo(Context context, ArrayList<Information> information) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(R.layout.list_item_park_two, parent, false);
        }
        ...
        phone.setText(currentInformation.getNumberPhone());
